...
import application.Controller.ManageSavedPropertyController;
...
public class ManageSavedPropertyBoundary implements Initializable {
	@FXML
...
//
//			);
	ObservableList<Property> array1 = ManageSavedPropertyController.retriveData();
	...
	public void removeButtonAction(ActionEvent event)throws IOException{
		ManageSavedPropertyController.deleteSavedProperty(AccountPass.userName, AccountPass.profile, IdPass.id);
		ObservableList<Property> removeList = ManageSavedPropertyController.retriveData();
		table.setItems(removeList);
		typeDetailLabel.setText("Removed!");
