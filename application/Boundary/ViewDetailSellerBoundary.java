...
public class ViewDetailSellerBoundary implements Initializable {
...
//			);
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		for(Useraccount user:array1) {
			if(user.getUsername().toString().equals(ObjectPass.userName)&&user.getProfile().equals("Seller")) {
					Useraccount seller =user;	
					System.out.println(seller.getPassword());
					passwordTextField.setText(seller.getPassword());
					phoneTextField.setText(seller.getPhone_number());
					fullNameTextField.setText(seller.getName());
...
//		System.out.println(userNameDetailLabel.getText().toString()+" "+ passwordTextField.getText().toString()+" "+ fullNameTextField.getText().toString()+ " "+emailTextField.getText().toString()+ " null"+ " null"+" null"+ " Admin"+ " Deactivate");
		...
		boolean result = ViewDetailedAdminController.updateAdminAccount(userNameDetailLabel.getText().toString(), passwordTextField.getText().toString(), fullNameTextField.getText().toString(), emailTextField.getText().toString(), phoneTextField.getText().toString(),null, null, "Seller", "active");
	...
	public void deactivateButtonAction(ActionEvent event)throws IOException{
		...
		boolean result = ViewDetailedAdminController.deactivate(userNameDetailLabel.getText().toString(), passwordTextField.getText().toString(), fullNameTextField.getText().toString(), emailTextField.getText().toString(), phoneTextField.getText().toString(),null, null, "Seller", "Deactivate");
